...
//    private static MiLinkServerManagerForSimpleChannel sInstance = null;

    public MiLinkServerManagerForSimpleChannel(MiLinkIpInfoManagerForSimpleChannel ipinfo) {
        super(ipinfo);
    }

//    public static MiLinkServerManagerForSimpleChannel getInstance() {
//        if (sInstance == null) {
//            synchronized (MiLinkServerManagerForSimpleChannel.class) {
//                if (sInstance == null) {
//                    sInstance = new MiLinkServerManagerForSimpleChannel();
//                }
//            }
//        }
//        return sInstance;
