...
public class MiLinkBackupServerManagerForSimpleChannel extends IServerManager {
	 ...
	 private static final String TAG = "MiLinkBackupServerManagerForSimpleChannel";

//   private static MiLinkServerManagerForSimpleChannel sInstance = null;

   public MiLinkBackupServerManagerForSimpleChannel(MiLinkIpInfoManagerForSimpleChannel ipinfo) {
       super(ipinfo);
   }
    @Override
